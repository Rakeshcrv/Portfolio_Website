...
const projects = [
  ...
  {
    title: "Flask Deployment Dashboard",
    ...
    demo: null,
    description:
      "Deployment management dashboard built with Flask to monitor applications, track release history, and visualize deployment activity.",
    tags: ["Flask", "Python", "SQLite", "GitHub"],
    highlights: [
      "Deployment tracking",
      "Service monitoring",
      "Release history",
