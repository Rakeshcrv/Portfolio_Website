...
const projects = [
  ...
  },
  {
    ...
    "Framer Motion"],
    highlights: [
      "Interactive production architecture visualization",
    "Live microservices workflow simulation",
    "Cloud-native e-commerce request lifecycle",
    "Real-time logs and metrics dashboard",
    "Distributed tracing visualization",
    "Event-driven architecture with Kafka",
    "Kubernetes deployment simulation",
    "AI-powered architecture copilot (Planned)"
    ],
  },
];
