...
const projects = [
  ...
  },
  {
    ...
    "Interactive cloud infrastructure visualizer",
    "Real-time microservices request flow simulation",
    "API Gateway, Auth, Catalog, Cart, Payment & Order workflow",
    "Distributed system architecture demonstration",
    "Live logs, metrics and service health visualization",
    "Cloud-native deployment architecture",
    "Dockerized production deployment",
    "AWS EC2 + Nginx hosting",
    "Modern observability-focused user experience"
    ],
  },
];
